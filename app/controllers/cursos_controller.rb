class CursosController < ApplicationController
  ...
  private
    ...
    def curso_params
      params.require(:curso)
            .permit(:nome, :string, :cdg_ordem_instrutor, 
                    :data_inicio, :data_fim, :numero_vagas, 
                    :numero_vagas_ocupadas, :nota, 
                    pessoas_cursos_attributes: [:id, :cdg_ordem_pessoa, 
                                                :curso_id, :_destroy])
    end
end
